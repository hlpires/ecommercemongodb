...
const Cart = () => {
  ...
  return (
    <div >
      ...
      <div className='cartPage' style={{ height: '80vh', maxHeight: '1000px' }}>
        <div className='position' style={{ marginTop: '50px', marginLeft: '-100px' }}>
            ...
            <div className='cartPageItemBox'>
              ...
              {cartItens.map(({ name, imageurl, price, numero, id }) => (
                <div className='cartPageBox' key={'1'}>
                  ...
                  <CloseIcon style={{ marginTop: '60px', fontSize: '40px', cursor: 'pointer' }} onClick={() => removeItem(id)}></CloseIcon>
                </div>
              ))}
            </div>
            <div className='cartPageCheckoutBox' style={{ marginLeft: '40px' }}>
